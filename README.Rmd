...
[![Travis-CI Build Status](https://travis-ci.org/slu-openGIS/areal?branch=master)](https://travis-ci.org/slu-openGIS/areal)
...
Output can also be generated as an `sf` object:
