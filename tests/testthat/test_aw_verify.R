...
test_that("errors with missing parameters", {
  ...
  expect_error(aw_verify(source = aw_stl_race, result = totalResult1, resultValue = TOTAL_E),
  ...
  expect_error(aw_verify(source = aw_stl_race, sourceValue = TOTAL_E, result = totalResult1),
...
test_that("errors with misspecified parameters", {
  ...
  expect_error(aw_verify(source = aw_stl_race, sourceValue = TOTAL_E,
...
test_that("correctly returns logic test results", {
  expect_equal(aw_verify(source = aw_stl_race, sourceValue = TOTAL_E,
