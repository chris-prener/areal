...
test_that("errors with missing objects", {
  expect_error(aw_calculate(ham, value = "TOTAL_E", areaWeight = "...areaWeight", newVar = "TOTAL_E"),
               "object 'ham' not found")
})

test_that("errors with missing parameters", {
  expect_error(aw_calculate(value = "TOTAL_E", areaWeight = "...areaWeight", newVar = "TOTAL_E"),
               "A sf object containing intersected data must be specified for the '.data' argument.")
  expect_error(aw_calculate(intersect, areaWeight = "...areaWeight", newVar = "TOTAL_E"),
               "A variable name must be specified for the 'value' argument.")
  expect_error(aw_calculate(intersect, value = "TOTAL_E", newVar = "TOTAL_E"),
               "A variable name must be specified for the 'areaWeight' argument.")
  expect_error(aw_calculate(intersect, value = "TOTAL_E", areaWeight = "...areaWeight"),
               "A variable name must be specified for the 'newVar' argument.")
})

test_that("errors with misspecified parameters", {
  expect_error(aw_calculate(intersect, value = "ham", areaWeight = "...areaWeight", newVar = "TOTAL_E"),
               "Variable 'ham', given for the value, cannot be found in the given intersected object.")
  expect_error(aw_calculate(intersect, value = "...area", areaWeight = "ham", newVar = "TOTAL_E"),
